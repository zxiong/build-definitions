...
## Additional info
### Parallel Processing
The MAX_PARALLEL parameter controls how many related images are scanned concurrently. The default value is "5", but this can be adjusted based on your resource availability and performance requirements. Increasing this value can speed up the scan for FBC fragments with many related images, but may require more memory and CPU resources.
